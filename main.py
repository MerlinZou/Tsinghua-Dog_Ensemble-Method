...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default='/home/rao/jittor/data/TsinghuaDogs')
    ...
    epochs = args.epochs
    model1 = Net1(num_classes=args.num_classes)
    model2 = Net2(num_classes=args.num_classes)
    model3 = Net3(num_classes=args.num_classes)
    lr = args.lr
